 ...
 */
final class Version20240717134623 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE avis (id INT AUTO_INCREMENT NOT NULL, zoo_arcadia_id INT DEFAULT NULL, pseudo VARCHAR(25) NOT NULL, text LONGTEXT NOT NULL, note INT NOT NULL, approuve TINYINT(1) NOT NULL, INDEX IDX_8F91ABF0FFE875C9 (zoo_arcadia_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
